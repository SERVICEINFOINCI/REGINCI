    ...
    if (isset($_REQUEST['username'], $_REQUEST['email'], $_REQUEST['password1'], $_REQUEST['password2']))
 {
    ...
    ?>
        <form class="box" action="" method="post">
            ...
            <h1 class="box-title">GESTION DU STOCK DES ARTICLES</h1> 

            <input type="Text" class="box-input" name="Libelle_article"
             placeholder="Libelle article" required autocomplete="off" />

            <input type="number" class="box-input" name="Entree_quantite_article" placeholder="Entrèe quantité article" required />

            <input type="Text" class="box-input" name="Sortie_quantite_aticle" placeholder="Sortie quantité article" required autocomplete="off" />
